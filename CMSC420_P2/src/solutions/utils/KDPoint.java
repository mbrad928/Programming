...
public class KDPoint {
	...
	/**
	 * Initialize a <emph>k</emph>-dimensional <tt>KDPoint</tt> at the origin of the axes.
	 ...
	 * @param p1 One of the two <tt>KDPoint</tt>s to calculate the distance from (or to).
	 * @param p2 One of the two <tt>KDPoint</tt>s to calculate the distance from (or to).
